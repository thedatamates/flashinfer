...
cudaError_t Sm120Nvfp4D128RunDenseRaw(
  ...
  return d128::sm120_nvfp4_qkv_online_register_q_splitkv_full_grid_raw<
      1, false, SM120_NVFP4_CAUSAL, SM120_NVFP4_USE_SLIDING_WINDOW,
...
DenseKernelConfig Sm120Nvfp4D128DenseKernelConfig() {
...
void SM120Nvfp4FmhaRunDense(
  ...
  const auto kernel = Sm120Nvfp4D128DenseKernelConfig();

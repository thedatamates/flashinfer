...
struct Sm120Nvfp4D512PagedKernel {
  static constexpr int kHeadDim = 512;
  static constexpr int kTileM =
      attention::blackwell::sm120_nvfp4::d512::kCutlassTileM;
  static constexpr int kOutputGroupSpan = 4;
  using PagedParams =
  ...
  static cudaError_t run(
    ...
    return attention::blackwell::sm120_nvfp4::d512::
        sm120_nvfp4_qkv_online_register_q_splitkv_full_grid_raw<4, true>(
...
void SM120Nvfp4QuantizeQ(TensorView q, TensorView q_packed,
                         TensorView q_scales) {
  sm120_nvfp4_paged::QuantizeQImpl<Sm120Nvfp4D512PagedKernel>(
      q, q_packed, q_scales);
}
...
void SM120Nvfp4FmhaRunPagedBatch(
  ...
  sm120_nvfp4_paged::RunPagedBatchImpl<Sm120Nvfp4D512PagedKernel>(

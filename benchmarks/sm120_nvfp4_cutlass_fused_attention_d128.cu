...
// separate translation unit so we can replace the large CUTLASS storage path
// with a compact D128-native layout.
...
constexpr float kQkScale = 0.08838834764831845f;  // legacy fixed D128 path
